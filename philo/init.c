...
/*   Updated: 2024/08/14 09:14:40 by aheinane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_philosophers(t_philo *philo, t_main *table)
{
	int	i;
	...
	while (i < table->number_of_philo)
	{
		...
		philo[i].left_fork = (i + 1) % table->number_of_philo;
		i++;
	}
}
